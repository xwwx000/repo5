...
<form id="form" action="" method="post">
		<table width="98%" border="0" cellspacing="1" cellpadding="3"
			...
			<tr class="defaultBGColor">
				...
				<td width="30%"><span class="contentclass"><input type="text" name="macaddr" id="macaddr" size="30" maxlength="50"/></span></td>
			</tr>
			<tr class="defaultBGColor">
			...
			<tr class="defaultBGColor">
				<td class="editLabel" colspan="2" align="center" ><a href="#" id="btnsave"
...
function save() {
	...
	if (macaddr.length<1 || macaddr.length>50) {
		...
		$.ajax({
			url : "${ctx}/pda/addmacaddr",
			async : true,
			type : "post",
			dataType : "json",
			data : {macaddr:macaddr,status:status},
