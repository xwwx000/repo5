		...
		<table width="98%" border="0" cellspacing="1" cellpadding="3"
			...
			<tr class="defaultBGColor">
				...
				<td width="30%"><span class="contentclass"><input
						type="text" name="pdauserid" id="pdauserid" size="30"
						maxlength="50" /></span></td>
			</tr>
			<tr class="defaultBGColor">
				<td class="editLabel" width="20%" align="center">PDA用户名称</td>
				<td width="30%"><span class="contentclass"><input
						type="text" name="pdausername" id="pdausername" size="30"
						maxlength="50" /></span></td>
			</tr>
			<tr class="defaultBGColor">
			...
			<tr class="defaultBGColor">
				...
				<td width="30%"><span class="contentclass"><input
						type="text" name="pdadept" id="pdadept" size="30" maxlength="100" /></span></td>
			</tr>
			<tr class="defaultBGColor">
