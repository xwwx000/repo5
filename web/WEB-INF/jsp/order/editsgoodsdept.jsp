	...
	<form id="form" action="" method="post">
		...
		<table width="98%" border="0" cellspacing="1" cellpadding="3"
			...
			<tr class="defaultBGColor">
				<td class="editLabel" width="20%" align="center">发货单位名称</td>
				<td width="30%"><span class="contentclass"><input
						type="text" name="deptname" id="deptname" size="30"
						maxlength="50" value="${deptname}"/></span></td>
			</tr>
			<tr class="defaultBGColor">
				<td class="editLabel" width="20%" align="center">封签货品</td>
				<td width="30%"><span class="contentclass"><input
						type="text" name="deptmark" id="deptmark" size="30"
						maxlength="50" value="${deptmark}"/></span></td>
			</tr>
			<tr class="defaultBGColor">
