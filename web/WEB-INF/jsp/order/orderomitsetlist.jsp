...
<BODY>
	<FORM action="${ctx}/order/orderOmitSetList" id="orderOmitSetList" name="orderOmitSetList"
		method="post">
		<INPUT type="hidden" id="pageno" name="pageno" value="${pageList.pages.cpage}">
		<table width="98%" border="0" cellspacing="0" cellpadding="0"
			align="center">
			<tr>
				<td width="150" height="35" align="left" id="Title">运输数据--遗漏设置</td>
				<td bgcolor="#f7f7f7">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td align="right"
								...
								value="${rgoodsdept}" size=10 maxlength="60" /> &nbsp;&nbsp;查询日期： <input
		...
		<table width='98%' border='0' id='maintbl' cellspacing='1'
			...
			<c:forEach items="${pageList.objectList}" var="list"
				...
				<TR class="defaultBGColor" align="center"
					...
					<td>${list.rfid}</td>
					<td><a
						href="#" onclick="to_omitset('${list.id}')"><span>标记遗漏单</span></a>|<a
